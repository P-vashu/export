...
print("=" * 80)
print("AMAZON REVIEWS BAYESIAN ANALYSIS")
print("=" * 80)
...
# Standardize star_rating, helpful_votes, total_votes
...
# Create dummy variables for dataset_source (ebook as reference)
...
try:
    ...
    print("  - Using PyMC for Bayesian inference")
    ...
    if max_rhat < 1.01:
        print("✓ Model converged (all R-hat < 1.01)")
    else:
    ...
    with open('bayesian_results.txt', 'w') as f:
    ...
    print("\n  - Results saved to 'bayesian_results.txt'")
    ...
    print(f"  - Error: {e}")
    print("  - PyMC not available. Installing dependencies...")
    import subprocess
...
plt.title('Amazon Reviews Engagement Pattern: Helpful Votes vs Total Votes', fontsize=14, fontweight='bold')
